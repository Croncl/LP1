...
Base::Base(int cenario) : health(0) {
    initialize(cenario);
}
...
void Base::initialize(int cenario) {
    ...
    switch (cenario) {
        case 1:
            ...
            baseWidth = 160;
            baseHeight = 120;
            health = 0; // Valor de saúde padrão para cenário 1
            break;
        case 2:
            textureFile = "assets/002base.png";
            baseWidth = 160;
            baseHeight = 120;
            health = 0; // Valor de saúde padrão para cenário 2
            break;
        case 3:
            textureFile = "assets/003base.png";
            baseWidth = 120;
            baseHeight = 120;
            health = 0; // Valor de saúde padrão para cenário 3
            break;
        default:
